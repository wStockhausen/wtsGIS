...
#'
#' @description This function reads a shapefile and creates a \code{sf} spatial dataframe object.
#'
...
#'
#' @details The function uses \code{sf::st_read} to read the shapefile.
